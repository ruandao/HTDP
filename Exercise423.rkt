...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname Exercise423) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(check-expect (partition "abcde" 2)
              (list "ab" "cd" "e"))
