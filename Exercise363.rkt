...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname Exercise363) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(define (eval-definition1 ex f-name f-arg f-body )
  )
